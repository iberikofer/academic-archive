...
public class Athlete implements Cloneable, Comparable<Athlete> {
    ...
    private TrainingZone currentZone;
    private String type;
    ...
    private Rectangle textBg;
    private Rectangle energyBarBg;
    private Rectangle energyBar;
    private Rectangle activeBorder;
    private ImageView zoneEmojiView;

    public Athlete(String name, int age, double weight, double energyLvl, Equipment equipment, double x, double y, String type) {
        this.name = name;
        this.age = age;
        this.weight = weight;
    ...
    private void initVisuals() {
        ...
        // Фіолетово-малинова неонова аура
        ...
        imageView = new ImageView(getImageForType(this.type));
        imageView.setX(x + 10);
        imageView.setY(y + 50);
        ...
        // Правильний порядок: спочатку картинка, потім рамка, потім фони текстів та смужки (щоб рамка не перекривала їх)
    ...
    private Image getImageForType(String type) {
        String path = "/gymworld/athlete.png";
        if ("Powerlifter".equals(type)) {
            path = "/gymworld/power_lifter.png";
        } else if ("Gym Boss".equals(type)) {
            path = "/gymworld/gym_boss.png";
        }
    ...
    public void removeFromScene() {
        GymWorld.rootGroup.getChildren().remove(visualGroup);
    }
    ...
    public void setEnergyLvl(double energyLvl) {
        this.energyLvl = energyLvl;
        if (energyBar != null) {
            energyBar.setWidth(150 * (energyLvl / 100.0));
        }
    }
    ...
    public void setEquipment(Equipment equipment) {
        ...
        if (equipmentText != null) {
            equipmentText.setText("Equipment: " + (equipment != null ? equipment.getName() : "None"));
        }
    }
    ...
    public void setType(String type) {
        this.type = type;
        if (imageView != null) {
            imageView.setImage(getImageForType(type));
        }
    }
