...
public class EditDialog {
    public static void display(Athlete athlete) {
        ...
        layout.getChildren().addAll(typeLabel, typeCombo, nameLabel, nameInput, weightLabel, weightInput, energyLabel, energyInput, hasEquipment, eqLabel, eqCombo, submitButton);
