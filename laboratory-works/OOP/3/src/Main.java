            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    if (insertIndex >= 0 && insertIndex <= athletes.length) {
                        ...
                        while (newWeight < 20 || newWeight > 600) {
                            ...
                            newWeight = readInt(scanner, "Enter valid weight: ");
                        }
                ...
                case 6:
                    ...
                    if (sortChoice == 1) {
                        ...
                        Arrays.sort(athletes, new java.util.Comparator<>() {
                            @Override
                ...
                case 7:
                    ...
                    if (cloneIndex >= 0 && cloneIndex < athletes.length) {
                        try {
                            ...
                            original.setName(original.getName());
                            ...
                            } else if  (copyChoice.equalsIgnoreCase("n"))
                            {
                                cloneObj.setName(cloneObj
                                        .getName() + " (Cloned from " + "'" + original.getName() + "')");
                            }
                ...
                case 16:
                    ...
                    if (delName.equals("CANCEL_OPERATION")) break;
